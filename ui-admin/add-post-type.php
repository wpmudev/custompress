            ...
            <h3 class="ct-toggle"><?php _e('Support Regular Taxonomies', $this->text_domain) ?></h3>
               ...
               <tr>
                    ...
                    <?php if ( taxonomy_exists( 'category' ) ): ?>
                        <input type="checkbox" name="supports_reg_tax[category]" value="1" <?php echo ( isset( $_POST['supports_reg_tax']['category'] ) && '1' == $_POST['supports_reg_tax']['category'] ) ? 'checked' : ''; ?>>
                        <span class="description"><strong><?php _e( 'Categories', $this->text_domain ) ?></strong></span>
                    <?php endif; ?>
                    <br />
                    <?php if ( taxonomy_exists( 'post_tag' ) ): ?>
                        <input type="checkbox" name="supports_reg_tax[post_tag]" value="1" <?php echo ( isset( $_POST['supports_reg_tax']['post_tag'] ) && '1' == $_POST['supports_reg_tax']['post_tag'] ) ? 'checked' : ''; ?>>
