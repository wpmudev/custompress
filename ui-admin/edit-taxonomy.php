    ...
    <div class="ct-wrap-left">
        <div class="ct-table-wrap">
            ...
            <table class="form-table <?php do_action('ct_invalid_field_taxonomy_class'); ?>">
                <tr>
                    <th>
                        <label for="taxonomy"><?php _e('Taxonomy', $this->text_domain) ?> (<span class="ct-required"> required </span>)</label>
                    </th>
                    <td>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table publica">
                ...
                <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="public" value="1" <?php if ( isset( $taxonomy['public'] ) && !empty( $taxonomy['public'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', $this->text_domain); ?></strong></span>
                        <br />
                        <input type="radio" name="public" value="0" <?php if ( isset( $taxonomy['public'] ) && empty( $taxonomy['public'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', $this->text_domain); ?></strong></span>
                        <br />
                        <input type="radio" name="public" value="advanced" <?php if ( !isset( $taxonomy['public'] ) ) echo ( 'checked="checked"' ); ?>>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show-ui">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_ui" value="1" <?php if ( !empty( $taxonomy['show_ui'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', $this->text_domain); ?></strong></span>
                        <br />
                        <input type="radio" name="show_ui" value="0" <?php if ( empty( $taxonomy['show_ui'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', $this->text_domain); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show_tagcloud">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_tagcloud" value="1" <?php if ( !empty( $taxonomy['show_tagcloud'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', $this->text_domain); ?></strong></span>
                        <br />
                        <input type="radio" name="show_tagcloud" value="0" <?php if ( empty( $taxonomy['show_tagcloud'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', $this->text_domain); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table show-in-nav-menus">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="show_in_nav_menus" value="1" <?php if ( !empty( $taxonomy['show_in_nav_menus'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', $this->text_domain); ?></strong></span>
                        <br />
                        <input type="radio" name="show_in_nav_menus" value="0" <?php if ( empty( $taxonomy['show_in_nav_menus'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', $this->text_domain); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="hierarchical" value="1" <?php if ( !empty( $taxonomy['hierarchical'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', $this->text_domain); ?></strong></span>
                        <br />
                        <input type="radio" name="hierarchical" value="0" <?php if ( empty( $taxonomy['hierarchical'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', $this->text_domain); ?></strong></span>
                    </td>
                </tr>
            </table>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="rewrite" value="1" <?php if ( !empty( $taxonomy['rewrite'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', $this->text_domain); ?></strong></span>
						<br />
                        <span class="description"><?php _e('Default will use query var.', $this->text_domain); ?></span>
                        <br />
                        <input type="radio" name="rewrite" value="0" <?php if ( empty( $taxonomy['rewrite'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', $this->text_domain); ?></strong></span>
						<br />
						...
						<br /><br />
                        <input type="checkbox" name="rewrite_with_front" value="1" <?php if ( !empty( $taxonomy['rewrite']['with_front'] ) ) echo 'checked="checked"'; ?>>
						...
						<br /><br />
                        <input type="checkbox" name="rewrite_hierarchical" value="1" <?php if ( !empty( $taxonomy['rewrite']['hierarchical'] ) ) echo 'checked="checked"'; ?>>
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
               ...
               <tr>
                    <th></th>
                    <td>
                        <input type="radio" name="query_var" value="1" <?php if ( !empty( $taxonomy['query_var'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('TRUE', $this->text_domain); ?></strong></span>
                        <br />
                        <input type="radio" name="query_var" value="0" <?php if ( empty( $taxonomy['query_var'] ) ) echo ( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('FALSE', $this->text_domain); ?></strong></span>
                    </td>
                </tr>
            </table>
