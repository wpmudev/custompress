    ...
    <div class="ct-wrap-left">
        ...
        <div class="ct-table-wrap">
            ...
            <table class="form-table">
                <tr>
                    <th>
                        <label for="object_type[]"><?php _e('Post Type', 'content_types') ?> (<span class="ct-required"> <?php _e( 'required', $this->text_domain ); ?> </span>)</label>
                    </th>
                    <td>
            ...
            <table class="form-table">
               ...
               <tr>
                    ...
                    <td>
                        ...
                        <span class="description"><strong><?php _e('FALSE', 'content_types'); ?></strong></span>
                        <br />
                        <input type="radio" name="rewrite" value="advanced" <?php if ( isset( $taxonomy['rewrite']['slug'] ) ) echo( 'checked="checked"' ); ?>>
                        <span class="description"><strong><?php _e('CUSTOM SLUG', 'content_types'); ?></strong></span>
                        <br />
                        <input type="text" name="rewrite_slug" value="<?php if ( isset( $taxonomy['rewrite']['slug'] ) ) echo( $taxonomy['rewrite']['slug'] ); ?>" />
                        <br />
