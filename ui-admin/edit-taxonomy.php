		...
		<div class="ct-table-wrap">
			...
			<table class="form-table">
				<tr>
					...
					<td>
						<span class="description"><?php esc_html_e('Enable REST API support for this taxonomy. This is required in order to appear in Guttneberg editor.', $this->text_domain); ?></span>						
					</td>
				</tr>
				<tr>
					<th></th>
