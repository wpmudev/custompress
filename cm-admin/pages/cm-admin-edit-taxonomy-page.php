            ...
            <div class="cm-wrap-left">
                <div class="cm-table-wrap">
                    ...
                    <table class="form-table <?php do_action('cm_invalid_field_taxonomy_class'); ?>">
                        <tr>
                            <th>
                                <label for="taxonomy"><?php _e('Taxonomy', 'custommanager') ?> (<span class="cm-required"> required </span>)</label>
                            </th>
                            <td>
                ...
                <div class="cm-table-wrap">
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                <span class="description"><?php _e('False to prevent queries, or string to customize query var. Default will use $taxonomy as query var.', 'custommanager'); ?></span>
                            </td>
                        </tr>
                       <tr>
                            <th></th>
