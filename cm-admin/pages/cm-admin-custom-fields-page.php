...
function cm_admin_custom_fields_page( $custom_fields ) { ?>
    ...
    <div class="wrap cm-wrap">
        ...
        <h2><?php _e('Custom Fields', 'custompress'); ?></h2>
        <?php /** @todo
                    ...
                    <tr class="<?php echo ( $class ); ?>">
                        <td>
                            ...
                            <div class="row-actions">
                                <span class="edit">
                                    <a title="<?php _e('Edit this custom field', 'custompress'); ?>" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_edit_custom_field=' . $custom_field['field_id'] ) ); ?>">Edit</a> |
                                </span>
                                <span class="trash">
