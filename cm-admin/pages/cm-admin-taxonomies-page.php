        ...
        <tbody>
            <?php if ( !empty( $taxonomies )): ?>
                ...
                <tr class="<?php echo ( $class ); ?>">
                    <td>
                        <strong>
                            <a href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=taxonomy&cm_edit_taxonomy=' . $taxonomy ) ); ?>"><?php echo( $taxonomy ); ?></a>
                        </strong>
                        <div class="row-actions">
                            <span class="edit">
                                <a title="<?php _e('Edit this taxonomy', 'custompress'); ?>" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=taxonomy&cm_edit_taxonomy=' . $taxonomy ) ); ?>"><?php _e('Edit', 'custompress'); ?></a> |
                            </span>
                            <span class="trash">
                                <a class="submitdelete" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=taxonomy&cm_delete_taxonomy=' . $taxonomy ) ); ?>"><?php _e('Delete', 'custompress'); ?></a>
                            </span>
                        </div>
                    </td>
