...
function cm_admin_delete_custom_field_page( $custom_field ) {
    ...
    <h3><?php _e('Delete Custom Field', 'custompress'); ?></h3>
    <?php /** @todo
            ...
            <tr>
                <td>
                    ...
                    <div class="row-actions">
                        <span class="edit">
                            <a title="<?php _e('Edit this custom field', 'custompress'); ?>" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=custom_field&cm_edit_custom_field=' . $custom_field['field_id'] ) ); ?>"><?php _e('Edit', 'custompress'); ?></a> |
                        </span>
                        <span class="trash">
                            <a class="submitdelete" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=custom_field&cm_delete_custom_field=' . $custom_field['field_id'] . '&cm_delete_custom_field_secret=' . $nonce ) ); ?>"><?php _e('Delete Permanently', 'custompress'); ?></a>
                        </span>
                    </div>
                </td>
