...
function cm_admin_delete_post_type_page( $args ) {
    ...
    <h3><?php _e('Delete Post Type', 'custompress'); ?></h3>
    ...
    <table class="widefat">
        ...
        <tbody>
            <tr>
                <td>
                    <strong>
                        <a href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=post_type&cm_edit_post_type=' . $_GET['cm_delete_post_type'] ) ); ?>"><?php echo( $_GET['cm_delete_post_type'] ); ?></a>
                    </strong>
                    <div class="row-actions">
                        <span class="edit">
                            <a title="<?php _e('Edit this post type', 'custompress'); ?>" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=post_type&cm_edit_post_type=' . $_GET['cm_delete_post_type'] ) ); ?>"><?php _e('Edit', 'custompress'); ?></a> |
                        </span>
                        <span class="trash">
                            <a class="submitdelete" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_content_type=post_type&cm_delete_post_type=' . $_GET['cm_delete_post_type'] . '&cm_delete_post_type_secret=' . $nonce ) ); ?>"><?php _e('Delete Permanently', 'custompress'); ?></a>
                        </span>
                    </div>
                </td>
