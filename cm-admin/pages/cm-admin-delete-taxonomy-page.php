...
function cm_admin_delete_taxonomy_page( $args ) {
    ...
    <div class="wrap cm-wrap">
        ...
        <h2><?php _e('Delete Taxonomy', 'custompress'); ?></h2>
        <?php /** @todo
                ...
                <tr>
                    <td>
                        ...
                        <div class="row-actions">
                            <span class="edit">
                                <a title="<?php _e('Edit this taxonomy', 'custompress'); ?>" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_edit_taxonomy=' . $_GET['cm_delete_taxonomy'] )); ?>"><?php _e('Edit', 'custompress'); ?></a> |
                            </span>
                            <span class="trash">
                                <a class="submitdelete" href="<?php echo( admin_url( 'admin.php?page=' . $_GET['page'] . '&cm_delete_taxonomy=' . $_GET['cm_delete_taxonomy'] . '&cm_delete_taxonomy_secret=' . $nonce )); ?>"><?php _e('Delete Permanently', 'custompress'); ?></a>
                            </span>
                        </div>
                    </td>
